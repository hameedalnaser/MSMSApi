...
// //adding community tree 
// exports.onePersonTrace =(res,req,next)=>{
//     console.log('reached controoler')
//     // console.log('params: ',req.params.id)
//     communityid=1
//     trainings=[]
...
//     recommandations=[]
//     certificates=[]
//     con.query('SELECT * FROM trainings LEFT JOIN trainingstudents ON trainings.trainingid = trainingstudents.trainingid WHERE trainingstudents.communityid = ?',[communityid],
//     function(err,rows,fields){
//         if(err){
//             res.status(400).json({
//                 error : err
